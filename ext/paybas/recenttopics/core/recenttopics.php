			...
			if (sizeof($this->topic_list))
			{
				...
				if (sizeof($rowset))
				{
					...
					foreach ($rowset as $row)
					{
						...
						$view_topic_url_unread = append_sid("{$this->root_path}viewtopic.$this->phpEx", 'f=' . $forum_id . '&amp;t=' . $topic_id . '&amp;view=unread');
						$view_topic_url_last = append_sid("{$this->root_path}viewtopic.$this->phpEx", 'f=' . $forum_id . '&amp;p=' . $row['topic_last_post_id']);
						...
						$tpl_ary = array(
							...
							'U_NEWEST_POST'           => $view_topic_url_unread . '#unread',
							'U_LAST_POST'             => $view_topic_url_last . '#p' . $row['topic_last_post_id'],
